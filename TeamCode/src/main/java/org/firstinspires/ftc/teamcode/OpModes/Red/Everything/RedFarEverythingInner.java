...
public class RedFarEverythingInner extends LinearOpMode {
	...
	public void runOpMode() throws InterruptedException {
		...
		if (!isStopRequested()) {
			switch (duckLocation) {
				case 0: {
					robot.runAuto(Robot.AutonomousPath.RED_FAR_CAROUSEL_LEVEL_1_PARK_2_TRAJECTORY, this);
				} break;

				case 1: {
					robot.runAuto(Robot.AutonomousPath.RED_FAR_CAROUSEL_LEVEL_2_PARK_2_TRAJECTORY, this);
				} break;

				case 2: {
					robot.runAuto(Robot.AutonomousPath.RED_FAR_CAROUSEL_LEVEL_3_PARK_2_TRAJECTORY, this);
				} break;
			}
			requestOpModeStop();
		}
