...
@Disabled
@TeleOp(name="Red Close Everything Outer", group="Autonomous")
public class RedCloseEverythingOuter extends LinearOpMode {
	...
	public void runOpMode() throws InterruptedException {
		...
		if (!isStopRequested()) {
			switch (duckLocation) {
				case 0: {
					robot.runAuto(Robot.AutonomousPath.RED_CLOSE_CAROUSEL_LEVEL_1_PARK_1_TRAJECTORY, this);
				} break;

				case 1: {
					robot.runAuto(Robot.AutonomousPath.RED_CLOSE_CAROUSEL_LEVEL_2_PARK_1_TRAJECTORY, this);
				} break;

				case 2: {
					robot.runAuto(Robot.AutonomousPath.RED_CLOSE_CAROUSEL_LEVEL_3_PARK_1_TRAJECTORY, this);
				} break;
			}
			requestOpModeStop();
		}
