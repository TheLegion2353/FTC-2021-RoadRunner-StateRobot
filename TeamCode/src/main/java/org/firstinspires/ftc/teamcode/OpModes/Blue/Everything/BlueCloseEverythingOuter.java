...
@Disabled
@TeleOp(name="Blue Close Everything Outer", group="Autonomous")
public class BlueCloseEverythingOuter extends LinearOpMode {
	...
	public void runOpMode() throws InterruptedException {
		...
		if (!isStopRequested()) {
			switch (duckLocation) {
				...
				case 1: {
					robot.runAuto(Robot.AutonomousPath.BLUE_CLOSE_CAROUSEL_LEVEL_2_PARK_1_TRAJECTORY, this);
				} break;

				case 2: {
					robot.runAuto(Robot.AutonomousPath.BLUE_CLOSE_CAROUSEL_LEVEL_3_PARK_1_TRAJECTORY, this);
				} break;
			}
			requestOpModeStop();
		}
