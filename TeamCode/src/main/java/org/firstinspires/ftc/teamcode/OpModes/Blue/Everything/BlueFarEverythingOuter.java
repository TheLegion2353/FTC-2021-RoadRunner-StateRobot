...
public class BlueFarEverythingOuter extends LinearOpMode {
	...
	public void runOpMode() throws InterruptedException {
		...
		if (!isStopRequested()) {
			switch (duckLocation) {
				case 0: {
					robot.runAuto(Robot.AutonomousPath.BLUE_FAR_CAROUSEL_LEVEL_1_PARK_1_TRAJECTORY, this);
				} break;

				case 1: {
					robot.runAuto(Robot.AutonomousPath.BLUE_FAR_CAROUSEL_LEVEL_2_PARK_1_TRAJECTORY, this);
				} break;

				case 2: {
					robot.runAuto(Robot.AutonomousPath.BLUE_FAR_CAROUSEL_LEVEL_3_PARK_1_TRAJECTORY, this);
				} break;
			}
			requestOpModeStop();
		}
